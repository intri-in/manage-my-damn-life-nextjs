...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        if(await middleWareForAuthorisation(req,res))
        {
            ...
            if(req.body.etag!=null && req.body.etag.trim()!="" && req.body.data!=null && req.body.data.trim()!="" && req.body.updated!=null && req.body.updated.toString().trim()!="" && req.body.type!=null && req.body.type.trim()!="" && req.body.calendar_id!=null && req.body.calendar_id.toString().trim()!="" && req.body.caldav_accounts_id)
            {
                ...
                var currentCaldavAccountID=req.body.caldav_accounts_id
                ...
                if(response.result.status>=200 && response.result.status<300 && ( response.result.error==null || response.result.error=="" ))
                {
                    ...
                    {
                       objects = await response.client.fetchCalendarObjects({
